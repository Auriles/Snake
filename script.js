...
// Fonction au lancement de la page
...
// Fonction s'appliquant aux touches du clavier
...
function SnakeGame(canvasWidth, canvasHeight, blockSize, delay) {
  ...
  // Variable refreshCanvas en raison du setTimeOut
  var refreshCanvas = function() {
    instance.snake.moove();
...
function Snake(body, direction) {
  ...
  // Propriétés du constructeur Snake
  this.body = body;
...
function Apple(position) {
  ...
  // Propriétés du constructeur Apple
